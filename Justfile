...
embed-live-sim-log-90m:
	...
	NO_COLOR=1 CARGO_TERM_COLOR=never JUST_EMBED_FEATURES=online_benchmarking,live_sim,live_sim_90m bash scripts/embed_live_sim_log.sh

embed-live-sim-log-90m-fixed-rate:
	# Live sim on the 90 m / 10 min profile with fixed-rate algorithms.
	NO_COLOR=1 CARGO_TERM_COLOR=never JUST_EMBED_FEATURES=online_benchmarking,live_sim,live_sim_90m,fixed_rate_algorithms bash scripts/embed_live_sim_log.sh

embed-live-sim-log-90m-exp:
	# Live sim on the 90 m / 10 min profile with pure exponential algorithms.
	NO_COLOR=1 CARGO_TERM_COLOR=never JUST_EMBED_PROFILE=exp JUST_EMBED_NO_DEFAULT_FEATURES=1 JUST_EMBED_FEATURES=display,online_benchmarking,live_sim,live_sim_90m bash scripts/embed_live_sim_log.sh
...
embed-live-sim-log-20m-fixed-rate:
	...
	NO_COLOR=1 CARGO_TERM_COLOR=never JUST_EMBED_FEATURES=online_benchmarking,live_sim,live_sim_20m,fixed_rate_algorithms bash scripts/embed_live_sim_log.sh

embed-live-sim-log-20m-exp:
	# Live sim on the shorter 20 m / 2 min profile with pure exponential algorithms.
	NO_COLOR=1 CARGO_TERM_COLOR=never JUST_EMBED_PROFILE=exp JUST_EMBED_NO_DEFAULT_FEATURES=1 JUST_EMBED_FEATURES=display,online_benchmarking,live_sim,live_sim_20m bash scripts/embed_live_sim_log.sh

embed-live-sim-log-50m:
	# Live sim on a 50m profile with multi-stop deco and staged gases (18/45 + 50/00)
	NO_COLOR=1 CARGO_TERM_COLOR=never JUST_EMBED_FEATURES=online_benchmarking,live_sim,live_sim_50m bash scripts/embed_live_sim_log.sh
...
embed-live-sim-log-50m-fixed-rate:
	...
	NO_COLOR=1 CARGO_TERM_COLOR=never JUST_EMBED_FEATURES=online_benchmarking,live_sim,live_sim_50m,fixed_rate_algorithms bash scripts/embed_live_sim_log.sh
...
embed-live-sim-log-50m-exp:
	...
	NO_COLOR=1 CARGO_TERM_COLOR=never JUST_EMBED_PROFILE=exp JUST_EMBED_NO_DEFAULT_FEATURES=1 JUST_EMBED_FEATURES=display,online_benchmarking,live_sim,live_sim_50m bash scripts/embed_live_sim_log.sh
